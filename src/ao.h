...
typedef struct {
    ...
    GLuint ao_program;
    GLint ao_uniform_normal_texture_sampler0_location;
    GLint ao_uniform_color_texture_sampler0_location;
    GLint ao_uniform_normal_texture_sampler1_location;
    GLint ao_uniform_color_texture_sampler1_location;
